...
> ###A Note On Other Useful Commands to Log in Your Digital Lab Notebook
> *whoami*: Logging the whoami command into your file will allow you to see on what machine, or account on a remote machine, a command was run. If, for whatever reason, there is ever a confusion about where something was ran (for example, if you get different software output when running a command on different operating systems), knowing this information  can  help you untangle that.  
